...
const Home = () => {
	...
	useEffect(() => {
		dispatch(getProducts()), dispatch(getCategories())
	}, [dispatch])

	return (
		<div>
			<div className='w-[90%] m-auto flex gap-[30px] flex-col'>
				<div className='mt-[30px] flex flex-row w-[100%] md:hidden justify-between items-center p-[10px] border-[1px] rounded-[10px] text-[22px] m-auto'>
					<input
      ...
      '
							...
							<SwiperSlide key={el.id}>
								<div className='w-[100%] md:flex-row md:h-[55vh] p-[30px] flex flex-col h-[100vh] items-center justify-evenly bg-[#000]'>
									<div className='text-[#fff] gap-y-[20px] w-[90%] p-[20px] md:w-[50%]'>
										...
										<Link
											to={'/products'}
											className='underline text-[20px] flex items-center gap-[5px]'
										>
											Shop Now{' '}
											<svg
												xmlns='http://www.w3.org/2000/svg'
			...
			<div className='pb-[30px] mb-[50px]'>
				...
				<div className='flex justify-center w-[90%] m-auto border-b-[1px] border-b-[#B3B3B3]  items-center pb-[50px] '>
					<Link
						to={'/products'}
						className='rounded-[5px] text-[#fff] bg-[#DB4444] text-[18px] px-[30px] py-[10px]'
					>
						View All Products
					</Link>
				</div>
			...
			<div className='w-[90%] flex flex-col m-auto gap-y-[20px]'>
				...
				<div className='flex flex-col md:flex-row gap-y-[20px] md:gap-[100px] md:items-center'>
					<h1 className='text-[32px] md:text-[36px] font-[600]'>
						Browse By Category
					</h1>
			...
			<div className='pb-[30px] my-[50px]'>
				...
				>
					{categories.map(el => (
						<SwiperSlide
							className='cursor-pointer transition-colors duration-300 hover:bg-red-500 hover:text-white hover:border hover:border-black hover:shadow-2xl' 
							key={el.id}
						>
			...
			<div className='w-[90%] flex flex-col m-auto gap-y-[20px]'>
				...
				<div className='flex flex-col gap-y-[20px] justify-between md:flex-row md:items-center'>
					...
					<Link
						to={'/products'}
						className='bg-[#DB4444] text-[#fff] p-[10px] w-[50%] text-center text-[18px] rounded-[5px] md:w-[15%]'
					>
						View All
					</Link>
				</div>
  ...
  <SwiperSlide
    key={el.id}
    className="swiperSlide cursor-pointer transition-shadow duration-300 hover:shadow-lg"
  >
    <Card
      img={`${API}/images/${el.image}`}
      name={el.productName}
    ...
    />
			...
			<div className='w-[100%] md:w-[90%] m-auto md:flex-row md:h-[65vh] p-[10px] md:p-[30px] flex flex-col h-[100vh] items-center justify-evenly bg-[#000]'>
				<div className='text-[#fff] p-0 gap-y-[20px] w-[90%] md:p-[20px] flex flex-col justify-between md:w-[50%]'>
					...
					<Link
						to={'/products'}
						className='bg-[#00FF66] w-[50%] text-[#000] md:w-[35%] p-[10px] rounded-[5px] text-center text-[20px]'
					>
						Buy Now!
					</Link>
				</div>
					...
					<div className='flex flex-col gap-y-[30px] w-[100%] justify-between md:w-[48%]'>
						<div className='bg-[#000] w-[100%] h-[60vh] md:h-[40vh] p-[30px] flex flex-row-reverse justify-between'>
							...
							<div className='text-[white]'>
								...
								<button className='mt-2 px-4 py-2 text-[black] bg-[#fff]'>
									Shop Now
								</button>
							</div>
						</div>
