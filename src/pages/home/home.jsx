  ...
  const category=import.meta.env.VITE_API_Category
      ...
      <div>
          ...
          <div className='flex flex-wrap m-auto w-[90%] md:border-[##E5E5E5] md:border-r-[1px] md:w-[20%] md:gap-[0px] gap-[10px]'>
            {categories?.map((el) => (
              <span
                ...
                key={el.id}
                className='bg-[#F5F5F5] md:w-[100%] md:py-[5px] md:bg-[#fff] p-[10px] text-[18px] font-[400] rounded-[5px]'
              >
                {el.categoryName}
        ...
        <div className='pb-[30px] my-[50px]'>
          ...
          >
            {categories?.map(el => (
              <SwiperSlide className='swiperSlide' key={el.id}>
                <Category name={el.categoryName}        img={`${category}images/${el.categoryImage}`} />
              </SwiperSlide>
            ))}
          </Swiper>
        </div>
