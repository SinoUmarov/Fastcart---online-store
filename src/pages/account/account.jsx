	...
	return (
		<>
			<div className='flex'>
				<div>
					<div className=' w-[90%] my-[20px] flex flex-col md:flex-row items-center justify-between m-auto '>
						<p className='text-[#8d8d8d] text-[20px] w-[90%] m-auto py-[30px]'>
							Home / <samp className='text-[#000]'>My Account</samp>
						</p>
						<img
					...
					<div className='flex flex-col md:flex-row md:w-[90%] items-start justify-between m-auto'>
						<div className='flex flex-col md:flex-row md:w-[20%] justify-start md:h-[95vh] w-[90%] m-auto'>
							<div className='flex flex-col gap-y-[10px]'>
								...
								<div className='px-[20px] flex flex-col gap-y-[10px]'>
									...
									<p className='text-[16px] font-[400] text-[#808080]'>
										Address Book
									</p>
									<p className='text-[16px] font-[400] text-[#808080]'>
										My Payment Options
						...
						<div
							className='flex flex-col md:p-[30px] md:w-[70%] md:flex-row justify-between w-[90%] mb-[50px] mt-[0] flex-wrap p-[10px] rounded-[5px] gap-y-[10px] m-auto'
							style={{ boxShadow: '0 0 10px #0000001a' }}
						>
							<h1 className='text-[20px] font-[500] md:text-[28px] text-[#DB4444] w-[100%]'>
								Profile
							</h1>
							<div className='flex flex-col gap-y-[5px] md:w-[48%]'>
								<label
									className='text-[16px] pl-[10px] font-[600]'
									htmlFor='firstName'
								>
									First name
								</label>
								<input
									...
									className='border-[1px] border-[#C4C4C4] p-[10px] rounded-[5px] outline-0'
									type='text'
									id='firstName'
							...
							<h1 className='text-[18px] font-[400] pt-[10px]'>
								Password Changes
							</h1>
							<input
								className='border-[1px] w-[100%] border-[#C4C4C4] p-[10px] rounded-[5px] outline-0'
								type='text'
								placeholder='Current passwod'
							/>
							<input
								className='border-[1px] w-[100%] md:w-[48%] border-[#C4C4C4] p-[10px] rounded-[5px] outline-0'
								type='text'
							...
							<div className='flex flex-col w-[100%] gap-y-[10px] gap-x-[20px] md:w-[48%] md:flex-row-reverse md:mt-[20px]'>
								<button
									onClick={() => saveChanges()}
									className='p-[10px] w-[100%] text-[18px] text-[#fff] bg-[#DB4444] rounded-[5px]'
								>
									Save Changes
								</button>
								<button className='p-[10px] w-[100%] text-[18px] font-[500]'>
									Cancel
								</button>
							</div>
						</div>
				...
				<div>
					<div className='flex flex-col md:flex-row md:w-[90%] items-start justify-between m-auto mt-[130px]'>
						<div className='flex flex-col md:flex-row md:w-[20%] justify-start md:h-[95vh] w-[90%] m-auto'></div>
						<div
							className='flex flex-col md:p-[30px] md:w-[70%] md:flex-row justify-between w-[90%] mb-[50px] mt-[0] flex-wrap p-[10px] rounded-[5px] gap-y-[10px] m-auto'
							style={{ boxShadow: '0 0 10px #0000001a' }}
						>
